...
<head>
    ...
    <title>Edit Penumpang — Tiket Kapal Laut</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Penumpang</h1>
                                    ...
                                    <form method="POST" action="{{ route('penumpang.update', $penumpang->id) }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                   ...
                                                   id="tanggal_lahir"
                                                   name="tanggal_lahir"
                                                   value="{{ old('tanggal_lahir', optional($penumpang->tanggal_lahir)->format('Y-m-d')) }}"
                                                   required>
                                            @error('tanggal_lahir')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        @if($penumpang->isWalkIn())
                                            <p class="text-muted small">
                                                <i class="fas fa-info-circle"></i>
                                                Data penumpang ini berstatus <strong>walk-in</strong> (belum terhubung ke akun pengguna).
                                            </p>
                                        @else
                                            <p class="text-muted small">
                                                <i class="fas fa-user-check"></i>
                                                Terhubung dengan akun: <strong>{{ $penumpang->user->name ?? '-' }}</strong>
                                            </p>
                                        @endif
