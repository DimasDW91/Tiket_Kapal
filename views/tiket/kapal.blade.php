...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Kapal</h1>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <a href="{{ route('kapal.create') }}" class="btn btn-success btn-sm">
                                <i class="fas fa-plus fa-sm"></i> Tambah Kapal
                            </a>
                        </div>
                    </div>
                    @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus kapal <strong id="namaKapal"></strong>?
                    Data yang sudah terkait jadwal tidak dapat dihapus.
                </div>
    ...
    <script>
        // Isi form hapus & nama kapal sesuai baris yang dipilih
        $('#modalHapus').on('show.bs.modal', function (event) {
            ...
            form.action = "{{ url('kapal') }}/" + id;

            document.getElementById('namaKapal').textContent = nama;
        });
    </script>
