...
<head>
    ...
    <title>Edit Pelabuhan — Tiket Kapal Laut</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Pelabuhan</h1>
                        ...
                        <div class="col-sm-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Form Edit Pelabuhan</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('pelabuhan.update', $pelabuhan->id) }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="kode_pelabuhan"
                                                   name="kode_pelabuhan"
                                                   value="{{ old('kode_pelabuhan', $pelabuhan->kode_pelabuhan) }}"
                                                   required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('alamat') is-invalid @enderror"
                                                      ...
                                                      name="alamat"
                                                      rows="3"
                                                      required>{{ old('alamat', $pelabuhan->alamat) }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
