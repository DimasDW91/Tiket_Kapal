...
<head>
    ...
    <title>Tambah Penumpang — Tiket Kapal Laut</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Penumpang</h1>
                        <a href="{{ route('penumpang.index') }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Penumpang</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('penumpang.store') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="nama_penumpang">Nama Penumpang <span class="text-danger">*</span></label>
                                            <input type="text"
                                                   name="nama_penumpang"
                                                   id="nama_penumpang"
                                        ...
                                        <p class="text-muted small">
                                            ...
                                            Data penumpang yang ditambahkan melalui form ini berstatus <strong>walk-in</strong>
                                            (belum terhubung ke akun pengguna manapun).
                                        </p>

                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save"></i> Simpan
                                        </button>
                                        <a href="{{ route('penumpang.index') }}" class="btn btn-secondary ml-2">Batal</a>
                                    </form>
