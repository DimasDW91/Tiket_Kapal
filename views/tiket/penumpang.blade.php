...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <a href="{{ route('penumpang.create') }}" class="btn btn-success btn-sm">
                                <i class="fas fa-plus fa-sm"></i> Tambah Penumpang
                            </a>
                        </div>
                    </div>
                    @endif
                                                ...
                                                @foreach ($penumpang as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- Tombol Edit -->
                                                            <a href="{{ route('penumpang.edit', $item->id) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus penumpang <strong id="namaPenumpang"></strong>?
    ...
    <script>
        // Isi form hapus & nama penumpang sesuai baris yang dipilih
        $('#modalHapus').on('show.bs.modal', function (event) {
            ...
            form.action = "{{ url('penumpang') }}/" + id;

            document.getElementById('namaPenumpang').textContent = nama;
        });
    </script>
