...
<head>
    ...
    <title>Edit Tiket — Tiket Kapal Laut</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{ route('tiket.index') }}" class="btn btn-secondary btn-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('tiket.update', $tiket->id) }}">
                                            ...
                                            <select name="pemesanan_id"
                                                ...
                                                @foreach ($pemesananList as $pemesanan)
                                                    <option value="{{ $pemesanan->id }}"
                                                        {{ old('pemesanan_id', $tiket->pemesanan_id) == $pemesanan->id ? 'selected' : '' }}>
                                                        {{ $pemesanan->kode_booking }} — {{ $pemesanan->nama_pemesan_display }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('pemesanan_id')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   class="form-control @error('kode_tiket') is-invalid @enderror"
                                                   id="kode_tiket"
                                                   name="kode_tiket"
                                                   value="{{ old('kode_tiket', $tiket->kode_tiket) }}"
                                                   required>
                                            @error('kode_tiket')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="qr_code"
                                                   name="qr_code"
                                                   value="{{ old('qr_code', $tiket->qr_code) }}">
                                            @error('qr_code')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="status_tiket"
                                                ...
                                                <option value="digunakan" {{ old('status_tiket', $tiket->status_tiket) == 'digunakan' ? 'selected' : '' }}>Digunakan</option>
                                                <option value="dibatalkan" {{ old('status_tiket', $tiket->status_tiket) == 'dibatalkan' ? 'selected' : '' }}>Dibatalkan</option>
                                                <option value="kadaluarsa" {{ old('status_tiket', $tiket->status_tiket) == 'kadaluarsa' ? 'selected' : '' }}>Kadaluarsa</option>
                                            </select>
                                            @error('status_tiket')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        @if($tiket->sudahDicetak())
                                            <p class="text-muted small">
                                                <i class="fas fa-print"></i>
                                                Sudah dicetak pada {{ optional($tiket->waktu_cetak)->format('d/m/Y H:i') }}
                                                oleh <strong>{{ $tiket->pencetak->name ?? '-' }}</strong>.
                                            </p>
                                        @else
                                            <p class="text-muted small">
                                                <i class="fas fa-info-circle"></i>
                                                Tiket ini belum dicetak.
                                            </p>
                                        @endif
                                        ...
                                        <a href="{{ route('tiket.index') }}" class="btn btn-secondary ml-2">Batal</a>
                                    </form>
