...
<head>
    ...
    <title>Edit Jadwal — Tiket Kapal Laut</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Jadwal Kapal</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('jadwal.update', $jadwal->id) }}">
                                            ...
                                            <select name="kapal_id"
                                                ...
                                                @foreach ($kapalList as $kapal)
                                                    <option value="{{ $kapal->id }}"
                                                        {{ old('kapal_id', $jadwal->kapal_id) == $kapal->id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            <label for="pelabuhan_asal_id" class="form-label">Pelabuhan Asal</label>
                                            <select name="pelabuhan_asal_id"
                                                ...
                                                @foreach ($pelabuhanList as $pelabuhan)
                                                    <option value="{{ $pelabuhan->id }}"
                                                        {{ old('pelabuhan_asal_id', $jadwal->pelabuhan_asal_id) == $pelabuhan->id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            <label for="pelabuhan_tujuan_id" class="form-label">Pelabuhan Tujuan</label>
                                            <select name="pelabuhan_tujuan_id"
                                                ...
                                                @foreach ($pelabuhanList as $pelabuhan)
                                                    <option value="{{ $pelabuhan->id }}"
                                                        {{ old('pelabuhan_tujuan_id', $jadwal->pelabuhan_tujuan_id) == $pelabuhan->id ? 'selected' : '' }}>
                                                        {{ $pelabuhan->nama_pelabuhan }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            <label for="tanggal_berangkat" class="form-label">Tanggal &amp; Jam Berangkat</label>
                                            <input type="datetime-local"
                                                   class="form-control @error('tanggal_berangkat') is-invalid @enderror"
                                                   id="tanggal_berangkat"
                                                   name="tanggal_berangkat"
                                                   value="{{ old('tanggal_berangkat', optional($jadwal->tanggal_berangkat)->format('Y-m-d\TH:i')) }}"
                                                   required>
                                        ...
                                        <div class="mb-3">
                                            <label for="tanggal_tiba" class="form-label">Tanggal &amp; Jam Tiba</label>
                                            <input type="datetime-local"
                                                   class="form-control @error('tanggal_tiba') is-invalid @enderror"
                                                   id="tanggal_tiba"
                                                   name="tanggal_tiba"
                                                   value="{{ old('tanggal_tiba', optional($jadwal->tanggal_tiba)->format('Y-m-d\TH:i')) }}"
                                                   required>
                                            @error('tanggal_tiba')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
