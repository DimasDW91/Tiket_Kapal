...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Pelabuhan</h1>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <a href="{{ route('pelabuhan.create') }}" class="btn btn-success btn-sm">
                                <i class="fas fa-plus fa-sm"></i> Tambah Pelabuhan
                            </a>
                        </div>
                    </div>
                    @endif
                                                ...
                                                @foreach ($pelabuhan as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- Tombol Edit -->
                                                            <a href="{{ route('pelabuhan.edit', $item->id) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus pelabuhan <strong id="namaPelabuhan"></strong>?
                    Data yang sudah terkait jadwal kapal tidak dapat dihapus.
                </div>
    ...
    <script>
        // Isi form hapus & nama pelabuhan sesuai baris yang dipilih
        $('#modalHapus').on('show.bs.modal', function (event) {
            ...
            form.action = "{{ url('pelabuhan') }}/" + id;

            document.getElementById('namaPelabuhan').textContent = nama;
        });
    </script>
