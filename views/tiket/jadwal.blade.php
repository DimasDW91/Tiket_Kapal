...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Jadwal Kapal</h1>
                    </div>
                                            ...
                                            <tbody>
                                                @foreach ($jadwal as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ optional($item->pelabuhanAsal)->nama_pelabuhan ?? '-' }}
                                                            &rarr;
                                                            {{ optional($item->pelabuhanTujuan)->nama_pelabuhan ?? '-' }}
                                                        </td>
                                                        <td>{{ optional($item->tanggal_berangkat)->format('d/m/Y H:i') }}</td>
                                                        <td>{{ optional($item->tanggal_tiba)->format('d/m/Y H:i') }}</td>
                                                        <td>Rp {{ number_format($item->harga_tiket, 0, ',', '.') }}</td>
                                                        <td>{{ $item->kuota }}</td>
                                                        <td>{{ $item->sisaKuota() }}</td>
                                                        <td>
                                                            @php
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    data-id="{{ $item->id }}"
                                                                    data-nama="{{ optional($item->kapal)->nama_kapal }} ({{ optional($item->tanggal_berangkat)->format('d/m/Y H:i') }})">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus jadwal <strong id="namaJadwal"></strong>?
                    Data yang sudah memiliki pemesanan tidak dapat dihapus.
                </div>
    ...
    <script>
        // Isi form hapus & nama jadwal sesuai baris yang dipilih
        $('#modalHapus').on('show.bs.modal', function (event) {
            ...
            document.getElementById('namaJadwal').textContent = nama;
        });
    </script>
