...
<head>
    ...
    <title>Tambah Tiket — Tiket Kapal Laut</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('tiket.store') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="pemesanan_id">Pemesanan <span class="text-danger">*</span></label>
                                            ...
                                            @enderror
                                            <small class="form-text text-muted">Hanya menampilkan pemesanan berstatus <strong>dibayar</strong>.</small>
                                        </div>

                                        <div class="form-group">
                                            <label for="kode_tiket">Kode Tiket <span class="text-danger">*</span></label>
                                            <input type="text"
                                                   name="kode_tiket"
                                                   id="kode_tiket"
                                        ...
                                        <div class="form-group">
                                            <label for="status_tiket">Status Tiket <span class="text-danger">*</span></label>
                                            <select name="status_tiket"
                                                ...
                                                <option value="digunakan" {{ old('status_tiket') == 'digunakan' ? 'selected' : '' }}>Digunakan</option>
                                                <option value="dibatalkan" {{ old('status_tiket') == 'dibatalkan' ? 'selected' : '' }}>Dibatalkan</option>
                                                <option value="kadaluarsa" {{ old('status_tiket') == 'kadaluarsa' ? 'selected' : '' }}>Kadaluarsa</option>
                                            </select>
                                            @error('status_tiket')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
