...
<head>
    ...
    <title>Tambah Kapal — Tiket Kapal Laut</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('kapal.store') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="kode_kapal">Kode Kapal <span class="text-danger">*</span></label>
                                            <input type="text"
                                                   name="kode_kapal"
                                                   id="kode_kapal"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="fasilitas"
                                                      ...
                                                      placeholder="Contoh: AC, Kantin, Musholla, Ruang VIP">{{ old('fasilitas') }}</textarea>
                                            @error('fasilitas')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
